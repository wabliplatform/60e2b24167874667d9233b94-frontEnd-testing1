...
(function(root, factory) {
  ...
  describe('PostApi', function() {
    ...
    describe('getByParamspost', function() {
      it('should call getByParamspost successfully', function(done) {
        //uncomment below and update the code to test getByParamspost
        //instance.getByParamspost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
