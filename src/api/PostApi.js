...
export default class PostApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getByParamspost operation.
     * @callback module:api/PostApi~getByParamspostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Post>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PostApi~getByParamspostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Post>}
     */
    getByParamspost(attribute, value, callback) {
      let postBody = null;
      // verify the required parameter 'attribute' is set
      if (attribute === undefined || attribute === null) {
        throw new Error("Missing the required parameter 'attribute' when calling getByParamspost");
      }
      // verify the required parameter 'value' is set
      if (value === undefined || value === null) {
        throw new Error("Missing the required parameter 'value' when calling getByParamspost");
      }
      ...
      let returnType = [Post];
      return this.apiClient.callApi(
        '/post/getByParams/{attribute}/{value}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
